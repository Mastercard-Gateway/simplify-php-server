...
<div class="w-container message">
	...
	<div class="text">For running payments from your mobile applications, you can post <span class="code">simplifyToken</span> and <span class="code">amount</span> params to <span class="webpage"><a href="charge.php">charge.php</a></span>.</div>
</div>
